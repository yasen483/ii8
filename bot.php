...
if(!file_exists('config.json')){
	$token = readline('-Hi LUCIFER Enter Token: ');
	$id = readline('-Hi LUCIFER Enter Id: ');
		...
		if($update != null){
          ...
          $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendMessage([
                  'chat_id'=>$chatId,
                  'text'=>"• اهلن بك في اداة لوسيفر 🔥 لصيد متاحات انستقرام بكل السهوله 😎🤘
~ @BBLBB0 🍂",
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'LUCIFER 🧑🏻‍💻','url'=>'t.me/BBLBB0'],['text'=>'𝐌𝐘 𝐁𝐎𝐓𝐒 🔊','url'=>'t.me/BBLBB0']]
                      ]
                  ])
               ]);
           } if($text == '- عربي 👁'){
		       ...
		       'chat_id'=>$chatId,
                ...
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'مطور البوت 👨🏻‍💻','url'=>'t.me/BBLBB0'],['text'=>'قناة البوت 🔊','url'=>'t.me/BBLBB0']]
                      ]
                  ])
               ]);
...
طريقة عمل بوت الصيد هيه انك تقوم بجمع يوزرات من الانستقرام ووضعها بالبوت ويقوم بالتخمين على المتابعين او الذين يقوم بمتابعتهم حسب اختيار بالطبع هناك طرق اخرى للسحب عبر هاشتاق متلا او كلمات بالبحث",
                  ...
                  $bot->sendvideo([ 
                  'chat_id'=>$chatId,                  'video'=>"https://t.me/BBLBB0/8",
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
				    ...
				    $bot->sendvideo([
       'chat_id'=>$chatId,
       'video'=> "https://t.me/BBLBB0/114",
        'caption'=>'👨🏻‍💻- مرحبا عزيزي البوت مدفوع وليس مجاني
- لطلب تفعيل بوت صيد او ملفات يرجا مراسلة المطور 👇',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/BBLBB0']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/BBLBB0"]]
                  ]
							])
					]);
				}
